...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | CryptoCafe</title>
        <meta
          key="description"
          name="description"
          content="Stake CryptoCafe in return for xCryptoCafe, an interest bearing and fungible ERC20 token designed to share revenue generated by all CryptoCafe products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.sushi.com/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE CryptoCafe" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE CryptoCafe" />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking CryptoCafe for xCryptoCafe`)}
              </div>
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as CryptoCafe
                                proportional to your share of the CryptoCafeBar. When your CryptoCafe is staked into the CryptoCafeBar, you receive
                                xCryptoCafe in return for voting rights and a fully composable token that can interact with other protocols.
                                Your xCryptoCafe is continuously compounding, when you unstake you will receive all the originally deposited
                                CryptoCafe and any additional from fees.`)}
            </div>
            {/* <div className="flex">
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake CryptoCafe`) : i18n._(t`Unstake`)}
                  </p>
                  ...
                  {account && (
                    <a
                      ...
                      className={`
                            ...
                            `}
                    >
                      {i18n._(t`Your CryptoCafeBar Stats`)}
                    </a>
                  )}
                </div>
              </div>
